...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { cliente_id: @contacto.cliente_id, contacto: @contacto.contacto, tipocontacto_id: @contacto.tipocontacto_id }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { cliente_id: @contacto.cliente_id, contacto: @contacto.contacto, tipocontacto_id: @contacto.tipocontacto_id }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
